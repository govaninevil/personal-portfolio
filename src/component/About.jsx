...
import Img from "../assets/image/profile-img.jpg";

const About = () => {
    return (
        <div>
            <section className='m-5 p-5 bg-white rounded-xl'>
                <div className="profile">
                    <div className="image">
                        <img src={Img} alt="" />
                    </div>
                    <div className="heading">
                        <h2 className='text-[25px] font-[600] my-3'>Nevil Govani</h2>
                    </div>
                    <div className="dis">
                    ...
                    <div className="contect sm:flex gap-3">
                        <div className="contact mb-3">
                            <a href="tel:97732612459" className='inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-blue-200 px-6 py-4 font-medium  text-slate-600 transition hover:text-white hover:bg-blue-600 focus:outline-none focus:ring disabled:pointer-events-none disabled:opacity-50'>
                                <IoCallOutline className='text-3xl' />Book A Call
                            </a>
                        </div>
                        <div className="mail">
                            <a href="mailto:nevilgovani22@gmail.com" className='inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-6 py-4 font-medium  text-white transition hover:text-slate-600 hover:bg-blue-200 focus:outline-none focus:ring disabled:pointer-events-none disabled:opacity-50'>
                                <IoMailOutline className='text-3xl' />Send A Mail
                            </a>
                        </div>
                    </div>
